...
allowed-tools: Bash(node /home/amol/code/games/anagrams-trainer/.worktrees/cool-van-20260406-061015/.claude/skills/nori-sync-docs/script.js:*)
---
...
```bash
node /home/amol/code/games/anagrams-trainer/.worktrees/cool-van-20260406-061015/.claude/skills/nori-sync-docs/script.js
```
