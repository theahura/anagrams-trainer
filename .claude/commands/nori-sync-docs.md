...
allowed-tools: Bash(node /home/amol/code/games/anagrams-trainer/.worktrees/pure-yak-20260406-051857/.claude/skills/nori-sync-docs/script.js:*)
---
...
```bash
node /home/amol/code/games/anagrams-trainer/.worktrees/pure-yak-20260406-051857/.claude/skills/nori-sync-docs/script.js
```
