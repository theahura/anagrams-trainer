...
- **`speedrun/stats.test.js`** -- Tests default stats on empty localStorage, round-trip persistence, per-day isolation, personal best update logic (faster replaces, slower keeps old), and first-time PB from null
